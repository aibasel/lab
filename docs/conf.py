...
MOCK_MODULES = ['matplotlib', 'matplotlib.backends']
...
project = u'lab'
copyright = u'2011-2016 Jendrik Seipp'
...
latex_documents = [
  ('index', 'lab.tex', u'lab Documentation',
   u'Jendrik Seipp', 'manual'),
]
...
texinfo_documents = [
  ('index', 'lab', u'lab Documentation',
   u'Jendrik Seipp', 'lab', 'One line description of project.',
   'Miscellaneous'),
]
